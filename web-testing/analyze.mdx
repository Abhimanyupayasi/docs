...
1. **From the User Run Configuration**  
   ...
   👉 [/web-testing/user-run-config#⚙️-web-run-config-in-nextgen-qe](/web-testing/user-run-config#⚙️-web-run-config-in-nextgen-qe)

2. **From the Orchestrate Tab (Run Config Section)**  
   Navigate to:  
   👉 [/web-testing/orchestrate/run-config](/web-testing/orchestrate/run-config)
